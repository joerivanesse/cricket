...
export const Home =() => {
    ...
    <section id ="home" className="min-h-screen flex items-center justify-center relative">
        ...
        <div className="text-center z-10 px-4">
            <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-red-800 to-yellow-400 bg-clip-text text-transparent leading-right">
                Hola, mi nombre es Joeri van Esse!
            </h1>

            <p className="text-gray-400 text-lg mb-8 max-w-lg mx-auto">
            Yo tengo 30 años y me gusta el padel. Estoy comprometido con mi pareja Rianne y vivimos en Rhenen. 
            </p>
